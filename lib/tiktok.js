...
/**
 * Scopes we request. Read scopes + video.upload (Content Posting draft).
 * Active app (sandbox now) must have these enabled or login will fail.
 */
export const SCOPES = ["user.info.basic", "user.info.stats", "video.list", "video.upload"];
